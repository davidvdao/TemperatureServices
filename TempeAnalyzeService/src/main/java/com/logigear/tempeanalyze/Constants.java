...
public class Constants
{
	...
	public class Routes
	{
		...
		public static final String GET_AVR_TEMPERATURE = "get.avarage.temperature";
		public static final String GET_MAX_TEMPERATURE = "get.max.temperature";
		public static final String GET_MIN_TEMPERATURE = "get.min.temperature";
	}
}
